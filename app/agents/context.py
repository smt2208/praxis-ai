...
Shared prompt and conversation context builders used across all agent teams.
Constructs history summaries, document context gates, image context, and user profile blocks.
"""
