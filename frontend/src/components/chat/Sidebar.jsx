                ...
                >
                  ...
                  <button
                    ...
                    style={{
                      ...
                      border: isConfirming ? '1px solid rgba(239, 68, 68, 0.25)' : 'none',
                      cursor: 'pointer',
                      color: isConfirming ? 'var(--accent-rose)' : 'var(--text-dim)',
                    ...
                    onMouseEnter={(e) => { if (!isConfirming) { e.currentTarget.style.opacity = '1'; e.currentTarget.style.color = 'var(--accent-rose)'; } }}
